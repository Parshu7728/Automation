...
public class Advanced_user_ACS_HandProtection_Report_Download extends BaseClass{
    ...
    public void ACSBodyProtection_Report_Download() throws Exception {
        ...
        // Select charts in ACS Hand Protection
        ...
        // Wait for the page to load before verifying the file
        Thread.sleep(5000);
