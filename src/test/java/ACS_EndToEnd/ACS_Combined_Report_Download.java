 ...
 * the combined ACS Hand Protection and Body Protection report. It extends the
 * BaseClass and uses various page objects and utilities to perform the test.
 */
public class ACS_Combined_Report_Download extends BaseClass {
...
//		combined_Report.exposureInBoth();
		...
		combined_Report.acs_Report_Details();
