...
public class Basic_usr_BP_ptd_TC extends BaseClass {
    ...
    public void ansell_usr_ptd() throws InterruptedException {
        ...
        ptd.scrollToTop();
        my_Report.navigate_from_PTD_MyReportPage();
        ptd.verifyReport();
        String expectedPdfPath = "E:/AutomationAGC/Automation/src/main/resources/Expected-PDF/BP_BasicPTD.pdf";
