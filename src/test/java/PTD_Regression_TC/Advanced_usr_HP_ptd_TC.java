...
public class Advanced_usr_HP_ptd_TC extends BaseClass {
    ...
    public void ansell_usr_ptd() throws InterruptedException {
        ...
        ptd.verifyReport();
        String expectedPdfPath = "E:/AutomationAGC/Automation/src/main/resources/Expected-PDF/HP_AdvancePTD.pdf";
