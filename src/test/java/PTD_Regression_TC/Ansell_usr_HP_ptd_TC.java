...
public class Ansell_usr_HP_ptd_TC extends BaseClass {

    String productgroup = prop_utility.ptd_ProductGroupHP();
    ...
    public void ansell_usr_ptd() throws InterruptedException {
       ...
       // ptd.clickHandProtection();
        ...
        ptd.verifyAnsellReport();
        String expectedPdfPath = "E:/AutomationAGC/Automation/src/main/resources/Expected-PDF/HP_AnsellPTD.pdf";
