...
public class Ansell_usr_BP_ptd_TC extends BaseClass {
    ...
    public void ansell_usr_ptd() throws InterruptedException {
     ...
     // String   expectedPdfPath = "C:/Users/ParashuramRY/Desktop/Ansell_OrgQPfWTRRY.pdf";
        String expectedPdfPath = "E:/AutomationAGC/Automation/src/main/resources/Expected-PDF/BP_AnsellPTD.pdf";
    ...
    /**
     * Helper method to find the downloaded PDF file in the specified directory
     * @param downloadDirPath The directory path where PDFs are downloaded
     * @return The full path to the downloaded PDF file, or null if not found
     */
